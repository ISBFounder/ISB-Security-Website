...
export const metadata: Metadata = {
  ...
  description:
    "ISB Security Platform implements controlled identity, role-based access, tenant isolation, object-based permissions, document security, audit logging and operational accountability.",
  alternates: { canonical: `${SITE.url}/security` },
  openGraph: {
    title: `Security & Trust | ${SITE.name}`,
    description:
      "Implemented security foundation: tenant isolation, authorization model, object-based permissions, document security and audit logging.",
  ...
  twitter: {
    ...
    title: `Security & Trust | ${SITE.name}`,
    description:
      "Implemented security foundation: tenant isolation, authorization, object permissions, document security and audit logging.",
  },
};
        ...
        <div className="container-site">
          <div className="max-w-3xl">
            ...
            <p className="body-lg mt-6 max-w-2xl">
              ISB Security Platform implements controlled identity,
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="body mt-4">
                Tenant isolation is part of the implemented platform foundation.
                ...
                complete isolation guaranteed under all failure modes.
              </p>
            </div>
      ...
      <section className="section divider">
        <div className="container-site">
          <SectionHeader
            ...
            description="Tenant isolation, role and persona-based authorization, object-based permissions, customer isolation, dispatcher scope control, row-level security, server-side validation and controlled API access are part of the implemented security foundation."
          />
        </div>
      </section>
      ...
      <section className="section divider bg-bg-secondary/40">
        <div className="container-site">
          <SectionHeader
            ...
            description="Audit logging is implemented for operational accountability: report creation, review, approvals, object instruction changes, assignments, qualifications, escalations and administrative changes. Traceable operational actions — not a claim of legal immutability."
          />
            ...
            {[
              {
                ...
                items:
                  "RBAC · tenant isolation · RLS · persona authorization · object permissions · document classification · entity-scoped audit · correlation IDs · secure document access",
              },
              {
          ...
          <div className="mt-8 max-w-2xl space-y-0 border-t border-border">
            {[
              ...
              },
              {
                ...
                a: "Through tenant-aware data boundaries and context-scoped access. Tenant isolation is part of the implemented foundation — not a guarantee of complete isolation under all failure modes.",
              },
              {
                q: "Does ISB support role-based access?",
                a: "Yes. The platform implements least-privilege role and permission scopes, including object-based permissions.",
              },
              {
                q: "How are actions audited?",
                a: "Critical operational actions are logged and associated with users. Audit logging is implemented for operational accountability — traceable, not claimed immutable.",
              },
              {
                q: "Is AI autonomous?",
